...
def generate_yaml_from_isolation_result(file, output_file, min_diffs=False):
    data = []
                    ...
                    data.append(
                        {
                            ...
                            "feature_name": cols[1],
                            "isolation_result": cols[2],
                            "number_min_differences": 1,
                            "min_differences": [cols[3]],
                        }
                    )
...
if __name__ == "__main__":
    ...
    min_diffs = True if len(sys.argv) > 3 and sys.argv[3].lower() == "true" else False
    generate_yaml_from_isolation_result(sys.argv[1], output_file, min_diffs)
