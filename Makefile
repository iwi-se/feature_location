...
exampl_java:
	python3 feature_location/feature_location_cli.py difference spl/00002.config/ spl/00004.config/ -- spl/00001.config/ spl/00003.config/

example_file:
	python3 feature_location/feature_location_cli.py file example-config.yaml

.PHONY: requirements test example_difference_logging example_difference_checked example_difference_iterative example_difference_logging_or_checked example_java example_file
